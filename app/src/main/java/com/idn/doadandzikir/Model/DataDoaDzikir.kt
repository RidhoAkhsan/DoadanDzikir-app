...
object DataDoaDzikir {
    ...
    val listDzikir: List<DoadanDzikirItem>
        get() {
            val listDzikir = mutableListOf<DoadanDzikirItem>()
    ...
    val listDzikirPagi: List<DoadanDzikirItem>
        get() {
            val listDzikirPagi = mutableListOf<DoadanDzikirItem>()
    ...
    val listDzikirPetang: List<DoadanDzikirItem>
        get() {
            val listDzikirPetang = mutableListOf<DoadanDzikirItem>()
